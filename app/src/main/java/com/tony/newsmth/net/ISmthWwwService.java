 ...
 */
public interface ISmthWwwService {

//    OkHttp  : --> POST http://www.newsmth.net/nForum/user/ajax_login.json http/1.1
//    OkHttp  : Content-Type: application/x-www-form-urlencoded
//    OkHttp  : Content-Length: 43
//    OkHttp  : X-Requested-With: XMLHttpRequest
//    OkHttp  : id=xxxxxxxx&passwd=xxxxxxxx&CookieDate=2
//    OkHttp  : --> END POST (43-byte body)
    @FormUrlEncoded
...
//
    ...
    Observable<ResponseBody> getTopicDetailByPage(@Path("boardEngName") String boardEngName,
